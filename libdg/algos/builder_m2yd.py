...
from libdg.algos.observers.b_obvisitor_clustering import ObVisitorClustering
...
class NodeAlgoBuilderM2YD(NodeAlgoBuilder):
    def init_business(self, exp):
        ...
        observer = ObVisitorCleanUp(
            ObVisitorClustering(exp, MSelOracleVisitor(MSelTrLoss(max_es=args.es)), device))  # FIXME: change ObVisitor
