python main_out.py --te_d=0 --task=mnistcolor --keep_model
...
python main_out.py --te_d 0 1 2 --tr_d 3 4 5 6 7 8 9 --task=mnistcolor --debug --epos=10 --aname=m2yd --zd_dim=7
